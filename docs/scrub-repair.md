...
redirected to a different authority through its credential variables.
...
maintenance lease. Retention/Object Lock and recurring isolated restore plus
`git fsck --strict` remain separate required controls.
